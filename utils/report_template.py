...
Enviarei um dicionário contendo informações dessas reclamações dividas em 7 categorias: prioridade, status, empresa, produto, departamento, plano de SLA e categoria. 
Cada categoria contém listas de dados agregados, como o número de reclamações por empresa, produto, categoria, entre outros. Com esses dados consolidados, você deverá gerar um relatório formal e padronizado que ofereça uma visão geral da situação das reclamações.
